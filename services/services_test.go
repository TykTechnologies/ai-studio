...
func TestLLMService(t *testing.T) {
	...
	// Test CreateLLM
	llm, err := service.CreateLLM("TestLLM", "test-api-key", "https://api.test.com", 75, "Short desc", "Long desc", "https://logo.com", models.OPENAI, true, nil, "", []string{}, nil, nil, false, nil, nil)
	assert.NoError(t, err)
	assert.NotNil(t, llm)
	...
	updatedLLM, err := service.UpdateLLM(llm.ID, "UpdatedLLM", "updated-api-key", "https://updated-api.test.com", 80,
		"Updated short", "Updated long", "https://updated-logo.com", models.OPENAI, true, nil, "", []string{}, nil, nil, "", false, nil, nil)
	assert.NoError(t, err)
	...
	llm1, _ := service.CreateLLM("GPT-3", "key1", "https://api1.com", 70, "GPT-3 short", "GPT-3 long", "https://gpt3-logo.com", models.OPENAI, true, nil, "", []string{}, nil, nil, false, nil, nil)
	llm2, _ := service.CreateLLM("GPT-4", "key2", "https://api2.com", 85, "GPT-4 short", "GPT-4 long", "https://gpt4-logo.com", models.OPENAI, true, nil, "", []string{}, nil, nil, false, nil, nil)
	service.CreateLLM("BERT", "key3", "https://api3.com", 60, "BERT short", "BERT long", "https://bert-logo.com", models.OPENAI, true, nil, "", []string{}, nil, nil, false, nil, nil)
...
func TestCatalogueService(t *testing.T) {
	...
	llm, err := service.CreateLLM("TestLLM", "test-api-key", "https://api.test.com", 70, "Short desc", "Long desc", "https://logo.com", models.OPENAI, true, nil, "", []string{}, nil, nil, false, nil, nil)
	assert.NoError(t, err)
...
func TestCatalogueService_MultipleCatalogues(t *testing.T) {
	...
	llm1, _ := service.CreateLLM("GPT-3", "key1", "https://api1.com", 80, "GPT-3 short", "GPT-3 long", "https://gpt3-logo.com", models.OPENAI, true, nil, "", []string{}, nil, nil, false, nil, nil)
	llm2, _ := service.CreateLLM("BERT", "key2", "https://api2.com", 70, "BERT short", "BERT long", "https://bert-logo.com", models.OPENAI, true, nil, "", []string{}, nil, nil, false, nil, nil)
...
func TestSmartAPIKeyUpdateLogic(t *testing.T) {
	...
	t.Run("LLM_APIKey_SmartUpdate", func(t *testing.T) {
		...
		llm, err := service.CreateLLM("Test LLM", "initial-api-key", "https://api.test.com", 75,
			...
			"gpt-4", []string{}, nil, nil, false, nil, nil)
		assert.NoError(t, err)
