...
func (s *Service) CreateTool(name, description, toolType string, oasSpec []byte, privacyScore float64) (*models.Tool, error) {
	tool := &models.Tool{
		Name:         name,
...
func (s *Service) UpdateTool(id uint, name, description, toolType string, oasSpec []byte, privacyScore float64) (*models.Tool, error) {
