...
func TestDataCatalogueService(t *testing.T) {
	...
	datasource, err := service.CreateDatasource(
		...
		EmbedderInput{Vendor: "embed_vendor", URL: "embed_url", APIKey: "embed_api_key", Model: "embed_model"}, true)
	assert.NoError(t, err)
...
func TestDataCatalogueService_MultipleDataCataloguesScenario(t *testing.T) {
	...
	ds1, _ := service.CreateDatasource("Datasource 1", "Short 1", "Long 1", "icon1.png", "https://example1.com", 75, 1, []string{}, "conn_string1", "source_type1", "api_key1", "db1", EmbedderInput{Vendor: "embed_vendor1", URL: "embed_url1", APIKey: "embed_api_key1", Model: "embed_model1"}, true)
	ds2, _ := service.CreateDatasource("Datasource 2", "Short 2", "Long 2", "icon2.png", "https://example2.com", 80, 1, []string{}, "conn_string2", "source_type2", "api_key2", "db2", EmbedderInput{Vendor: "embed_vendor2", URL: "embed_url2", APIKey: "embed_api_key2", Model: "embed_model2"}, true)
