...
func New(cfg *config.Config, serviceContainer *services.ServiceContainer, version, buildHash, buildTime string) (*Server, error) {
	...
	routerConfig := &api.RouterConfig{
		...
		MetricsAuthToken:            cfg.Observability.MetricsAuthToken,
		MetricsAllowUnauthenticated: cfg.Observability.MetricsAllowUnauthenticated,
...
func (s *Server) SetReloadCoordinator(reloadCoordinator *services.ReloadCoordinator) {
	...
	routerConfig := &api.RouterConfig{
		...
		MetricsAuthToken:            s.config.Observability.MetricsAuthToken,
		MetricsAllowUnauthenticated: s.config.Observability.MetricsAllowUnauthenticated,
