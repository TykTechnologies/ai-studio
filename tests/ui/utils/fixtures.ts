...
import { AdminEmbeddersPage } from '@pom/Admin_embedders_page';
...
export const test = base.extend<{
    ...
    adminEmbeddersPage: AdminEmbeddersPage;
    }>({
    ...
    adminEmbeddersPage: async ({ page }, use) => {
        await use(new AdminEmbeddersPage(page));
    },
