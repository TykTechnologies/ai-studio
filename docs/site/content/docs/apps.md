...
The **Apps View** is a key feature of the Tyk AI Portal, enabling users to define, configure, and securely interact with LLMs and data sources through the AI Gateway while ensuring robust governance and control.
...
This **App Details View** is an essential feature for administrators to monitor, manage, and ensure the secure operation of user-created apps within the Tyk AI Portal.
...
The **App Edit View** is a critical feature for managing user-created apps in the Tyk AI Portal, providing administrators with full control over app configuration, approval, and access management.
