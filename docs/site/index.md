...
hero:
  name: Tyk AI Studio
  text: Accelerate AI innovation without sacrificing control
  tagline: Experience enterprise AI governance that works
  image:
    src: /centralized-management.webp
    alt: Tyk AI Studio Hero
  actions:
    - theme: brand
      text: Get a demo
      link: https://tyk.io/ai-demo/
    - theme: alt
      text: Learn more
...
features:
  - icon: 🗄️
    ...
    details: Unify and govern AI usage with role-based access, rate limiting, monitoring, and compliance controls.
  - icon: 🚪
    title: AI Gateway
    details: Securely proxy LLMs, integrate custom models, and track usage/costs through a central gateway.
  - icon: 🔍
    title: AI Portal
    details: Empower developers with a curated catalog of AI tools and services for faster innovation.
  - icon: 💬
    title: AI Chat
    details: Enable direct, secure interaction with AI tools and data sources via intuitive chat interfaces.
