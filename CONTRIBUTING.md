...
issue](https://github.com/TykTechnologies/ai-studio/issues/new).
...
The Tyk CLA [must be signed](https://github.com/TykTechnologies/ai-studio/blob/master/CLA.md) by all contributors. You will be automatically asked to sign CLA once PR will be created.
...
interesting](https://github.com/TykTechnologies/ai-studio/issues?q=is%3Aopen+is%3Aissue+label%3Ahelp-wanted).
...
To build and test Tyk use built-in `go` commands: `go build` and `go test -v`. If you want to just test a subset of the project, you can pass the `-run` argument with the name of the test. 
