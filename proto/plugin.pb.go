...
const file_plugin_proto_rawDesc = "" +
	...
	"\rerror_message\x18\x03 \x01(\tR\ferrorMessage2\xd3\b\n" +
	"\rPluginService\x127\n" +
	"\n" +
	...
	"\vGetManifest\x12\x1a.plugin.GetManifestRequest\x1a\x1b.plugin.GetManifestResponseB/Z-github.com/TykTechnologies/midsommar/v2/protob\x06proto3"
...
var file_plugin_proto_goTypes = []any{
	...
	nil,                            // 33: plugin.InitRequest.ConfigEntry
	nil,                            // 34: plugin.PluginContext.MetadataEntry
	nil,                            // 35: plugin.PluginContext.TraceContextEntry
	nil,                            // 36: plugin.PluginRequest.HeadersEntry
	nil,                            // 37: plugin.PluginResponse.HeadersEntry
	nil,                            // 38: plugin.AuthResponse.ClaimsEntry
	nil,                            // 39: plugin.EnrichedRequest.AuthClaimsEntry
	nil,                            // 40: plugin.HeadersRequest.HeadersEntry
	nil,                            // 41: plugin.HeadersResponse.HeadersEntry
	nil,                            // 42: plugin.ResponseWriteRequest.HeadersEntry
	nil,                            // 43: plugin.ResponseWriteResponse.HeadersEntry
	nil,                            // 44: plugin.App.MetadataEntry
	nil,                            // 45: plugin.User.MetadataEntry
	nil,                            // 46: plugin.DataCollectionResponse.MetadataEntry
}
var file_plugin_proto_depIdxs = []int32{
	33, // 0: plugin.InitRequest.config:type_name -> plugin.InitRequest.ConfigEntry
	34, // 1: plugin.PluginContext.metadata:type_name -> plugin.PluginContext.MetadataEntry
	35, // 2: plugin.PluginContext.trace_context:type_name -> plugin.PluginContext.TraceContextEntry
	36, // 3: plugin.PluginRequest.headers:type_name -> plugin.PluginRequest.HeadersEntry
	6,  // 4: plugin.PluginRequest.context:type_name -> plugin.PluginContext
	37, // 5: plugin.PluginResponse.headers:type_name -> plugin.PluginResponse.HeadersEntry
	...
	38, // 8: plugin.AuthResponse.claims:type_name -> plugin.AuthResponse.ClaimsEntry
	7,  // 9: plugin.EnrichedRequest.request:type_name -> plugin.PluginRequest
	39, // 10: plugin.EnrichedRequest.auth_claims:type_name -> plugin.EnrichedRequest.AuthClaimsEntry
	40, // 11: plugin.HeadersRequest.headers:type_name -> plugin.HeadersRequest.HeadersEntry
	6,  // 12: plugin.HeadersRequest.context:type_name -> plugin.PluginContext
	41, // 13: plugin.HeadersResponse.headers:type_name -> plugin.HeadersResponse.HeadersEntry
	42, // 14: plugin.ResponseWriteRequest.headers:type_name -> plugin.ResponseWriteRequest.HeadersEntry
	6,  // 15: plugin.ResponseWriteRequest.context:type_name -> plugin.PluginContext
	43, // 16: plugin.ResponseWriteResponse.headers:type_name -> plugin.ResponseWriteResponse.HeadersEntry
	...
	44, // 21: plugin.App.metadata:type_name -> plugin.App.MetadataEntry
	45, // 22: plugin.User.metadata:type_name -> plugin.User.MetadataEntry
	...
	46, // 26: plugin.DataCollectionResponse.metadata:type_name -> plugin.DataCollectionResponse.MetadataEntry
	...
	1,  // 44: plugin.PluginService.Initialize:output_type -> plugin.InitResponse
	3,  // 45: plugin.PluginService.Ping:output_type -> plugin.PingResponse
	5,  // 46: plugin.PluginService.Shutdown:output_type -> plugin.ShutdownResponse
	8,  // 47: plugin.PluginService.ProcessPreAuth:output_type -> plugin.PluginResponse
	10, // 48: plugin.PluginService.Authenticate:output_type -> plugin.AuthResponse
	17, // 49: plugin.PluginService.GetAppByCredential:output_type -> plugin.GetAppResponse
	19, // 50: plugin.PluginService.GetUserByCredential:output_type -> plugin.GetUserResponse
	8,  // 51: plugin.PluginService.ProcessPostAuth:output_type -> plugin.PluginResponse
	13, // 52: plugin.PluginService.OnBeforeWriteHeaders:output_type -> plugin.HeadersResponse
	15, // 53: plugin.PluginService.OnBeforeWrite:output_type -> plugin.ResponseWriteResponse
	25, // 54: plugin.PluginService.HandleProxyLog:output_type -> plugin.DataCollectionResponse
	25, // 55: plugin.PluginService.HandleAnalytics:output_type -> plugin.DataCollectionResponse
	25, // 56: plugin.PluginService.HandleBudgetUsage:output_type -> plugin.DataCollectionResponse
	27, // 57: plugin.PluginService.GetAsset:output_type -> plugin.GetAssetResponse
	29, // 58: plugin.PluginService.ListAssets:output_type -> plugin.ListAssetsResponse
	32, // 59: plugin.PluginService.GetManifest:output_type -> plugin.GetManifestResponse
