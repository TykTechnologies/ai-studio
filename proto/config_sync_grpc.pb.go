...
func (UnimplementedConfigurationSyncServiceServer) GetFullConfiguration(context.Context, *ConfigurationRequest) (*ConfigurationSnapshot, error) {
	return nil, status.Error(codes.Unimplemented, "method GetFullConfiguration not implemented")
}
...
func (UnimplementedConfigurationSyncServiceServer) UnregisterEdge(context.Context, *EdgeUnregistrationRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method UnregisterEdge not implemented")
}
...
func (UnimplementedConfigurationSyncServiceServer) SendAnalyticsPulse(context.Context, *AnalyticsPulse) (*AnalyticsPulseResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SendAnalyticsPulse not implemented")
}
func (UnimplementedConfigurationSyncServiceServer) SendPluginControlBatch(context.Context, *PluginControlBatch) (*PluginControlBatchResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SendPluginControlBatch not implemented")
}
...
func RegisterConfigurationSyncServiceServer(s grpc.ServiceRegistrar, srv ConfigurationSyncServiceServer) {
	// If the following call panics, it indicates UnimplementedConfigurationSyncServiceServer was
