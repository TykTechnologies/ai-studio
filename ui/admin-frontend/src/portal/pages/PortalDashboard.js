          ...
          {catalog.loading ? (
            ...
            <>
              <Box sx={{ display: "flex", flexWrap: "wrap", gap: 1.5, mb: 3 }} data-testid="overview-counts">
                {/* MCP servers and model/semantic routers are asset types like
                    the others; their tiles only show where the catalog has some. */}
                {[CATALOG_TYPES.LLM, CATALOG_TYPES.MODEL_ROUTER, CATALOG_TYPES.SEMANTIC_ROUTER, CATALOG_TYPES.DATASOURCE, CATALOG_TYPES.TOOL, CATALOG_TYPES.MCP_SERVER]
