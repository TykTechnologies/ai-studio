...
// Order matters: it is the order the groups are listed in the sentence.
const DEPENDENT_GROUPS = [
  ...
  { key: "model_routers", singular: "model router", plural: "model routers" },
];
