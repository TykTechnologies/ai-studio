...
func EncryptWith(ctx context.Context, c secrets.Cipher, rawKey string, plaintext string) (string, error) {
...
func DecryptWith(ctx context.Context, ciphers map[string]secrets.Cipher, rawKey string, value string) (string, error) {
...
func LegacyCipherInstances() map[string]secrets.Cipher {
	return map[string]secrets.Cipher{
		"v1": &CFBCipher{},
	}
}
